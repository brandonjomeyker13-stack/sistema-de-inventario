...
* `sistema_inventario` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `sistema inventario` - executable or bundle name on disk.
* `sistema inventario` - display name shown in window titles and about app dialogs.
